			...
			<div class="row">
				<div class="col-lg-3">
					<div class="footer-hotline">
						...
						<p>Hotline: 0978 825 468 (Giờ Mở Cửa 9:00 - 22:30)</p>
				...
				<div class="col-lg-3">
					<div class="footer-user">
						<a href="https://mail.google.com/mail/u/0/#inbox" class="footer-user__icon"> <i class="fas fa-user"></i>
						</a>
						<p>Hỗ Trợ Đơn Hàng: Hungpk22898@gmail.com </p>
					</div>
				</div>
				<div class="col-lg-3">
					<div class="footer-mail">
						...
						<p>Liên Hệ Hợp Tác: Sales@Hunglovena.com</p>
					</div>
				</div>
				<div class="col-lg-3">
					<div class="footer-address">
						<a href="https://goo.gl/maps/fnnphfnq1jGRq1cK6" class="footer-address__icon"> <i
							class="fas fa-map-marker-alt"></i>
						</a>
						<p>Chung cư CT2A, Xa La, Hà Đông, Hà Nội</p>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-4">
					<ul class="company">
						<li>
							<p>CÔNG TY TNHH MTV THƯƠNG MẠI DỊCH VỤ HNA</p>
						</li>
						<li>
							<p>Giấy CNĐKDN Số: 0316037655 do Sở kế hoạch và đầu tư</p>
						</li>
						<li>
							<p>Tp. HÀ NỘI cấp ngày 25/6/2022</p>
						</li>
					</ul>
				</div>
				<div class="col-lg-4">
					...
					<div class="social">
						<div class="social-nw">
							...
							<div class="social-nw__link">
								<a href="https://www.facebook.com/hung.phamkhanh.581/" class="social-nw__fb"> <img
									src="Page/img/facebook-icon.webp" alt="">
								</a> <a href="https://www.youtube.com/channel/UCwuK-28z2VZITdg3xWibNQQ" class="social-nw__ins"> <img
									src="Page/img/youtube-icon-new.webp" alt="">
								</a> <a href="https://www.instagram.com/hungpk98/" class="social-nw__youtube"> <img
